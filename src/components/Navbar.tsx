...
export function Navbar(){
      ...
      const {openCart, cartQuantity } = useContext(ShoppingCartContext)
          return(
     <NavbarBS sticky='top' className='bg-secondary shadow-sm navbar-inner'>
      <Container>
         ...
         <img className="rounded-sm" src='/imgs/cart icon 01.jpg'></img>
         <div
            className='rounded-circle bg-slate-700 d-flex justify-content-center align-items-center' style={ { 
               color:"white" ,
               width:"1.5rem",
               height:"1.5rem",
               position:"absolute",
